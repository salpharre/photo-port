...
function PhotoList({categoryName}) {
    ...
    //saved in state as an object that includes all the object key values pairs from the image + the index(which will be used to grab the image from the assets folder)
